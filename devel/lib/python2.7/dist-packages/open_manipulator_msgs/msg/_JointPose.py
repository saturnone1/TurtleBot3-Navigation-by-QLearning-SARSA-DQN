...
"""autogenerated by genpy from open_manipulator_msgs/JointPose.msg. Do not edit."""
import codecs
import sys
...
class JointPose(genpy.Message):
  _md5sum = "217de178e1835082dfab23527f9a9de9"
  _type = "open_manipulator_msgs/JointPose"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string[]   joint_name
float64[]  position
float64    move_time
"""
  __slots__ = ['joint_name','position','move_time']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.move_time,) = _get_struct_d().unpack(str[start:end])
      return self
